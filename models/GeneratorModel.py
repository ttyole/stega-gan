...
class GeneratorModel:
    ...
    def generator_prediction(self):
        ...
        x = tf.nn.conv2d(input=x, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        # Batch Normalization
        (mean, var) = tf.nn.moments(x, axes=[0],  keep_dims=False, name="moments1")
        ...
        x = tf.nn.conv2d(input=x, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(x, axes=[0],  keep_dims=False, name="moments2")
        x = tf.nn.batch_normalization(
            x, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        x = tf.nn.relu(x)
        ...
        y = tf.nn.conv2d(input=x, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments3")
        ...
        y = tf.nn.conv2d(input=y, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments4")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        ...
        y = tf.nn.conv2d(input=x, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments5")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        ...
        y = tf.nn.conv2d(input=y, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments6")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        x = tf.add(x,y)
        ...
        y = tf.nn.conv2d(input=x, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments7")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        ...
        y = tf.nn.conv2d(input=y, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments8")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        x = tf.add(x,y)
        ...
        y = tf.nn.conv2d(input=x, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments9")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        ...
        y = tf.nn.conv2d(input=y, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments10")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        x = tf.add(x,y)
        ...
        y = tf.nn.conv2d(input=x, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments11")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        ...
        y = tf.nn.conv2d(input=y, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments12")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        x = tf.add(x,y)
        ...
        y = tf.nn.conv2d(input=x, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments13")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        ...
        y = tf.nn.conv2d(input=y, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments14")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        x = tf.add(x,y)
        ...
        y = tf.nn.conv2d(input=x, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments15")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        ...
        y = tf.nn.conv2d(input=y, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments16")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        x = tf.add(x,y)
        ...
        y = tf.nn.conv2d(input=x, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments17")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        ...
        y = tf.nn.conv2d(input=y, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments18")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        x = tf.add(x,y)
        ...
        y = tf.nn.conv2d(input=x, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments19")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        ...
        y = tf.nn.conv2d(input=y, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments20")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        x = tf.add(x,y)
        ...
        y = tf.nn.conv2d(input=x, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments21")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        ...
        y = tf.nn.conv2d(input=y, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments22")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        x = tf.add(x,y)
        ...
        y = tf.nn.conv2d(input=x, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments23")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        ...
        y = tf.nn.conv2d(input=y, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(y, axes=[0],  keep_dims=False, name="moments24")
        y = tf.nn.batch_normalization(
            y, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        y = tf.nn.relu(y)
        x = tf.add(x,y)
        ...
        x = tf.nn.conv2d(input=x, filter=filter,
                         padding="SAME", strides=[1, 1, 1, 1])
        (mean, var) = tf.nn.moments(x, axes=[0],  keep_dims=False, name="moments25")
        x = tf.nn.batch_normalization(
            x, mean=mean, variance=var, scale=None, offset=None, variance_epsilon=0.00001)
        x = tf.nn.sigmoid(x)
        x = tf.subtract(x,0.5)
